...
typedef struct  
{
    uint8_t Line_Normal        : 1;
    uint8_t Line_Abnormal      : 1;
    uint8_t Line_Malfunction   : 1;
    uint8_t Line_AB_resume     : 1;
    uint8_t Line_MAL_resume    : 1;
    
}DEV_EVENT;

typedef struct  
{
    uint8_t  Zero_MainCurrent       : 1;
    uint8_t  Zero_SubCurrent        : 1;
    uint8_t  Zero_MainVoltage       : 1;
    uint8_t  Zero_SubVoltage        : 1;
    uint8_t  Broken_MainPower       : 1;
    uint8_t  Broken_SubPower        : 1;
}ZERO_STATUS;


typedef struct  
{
    uint8_t Dev_MainSCR : 1;
    uint8_t Dev_MainRelay : 1;
    uint8_t Dev_SubSCR : 1;
    uint8_t Dev_SubRelay : 1;
}DEV_STATUE;
